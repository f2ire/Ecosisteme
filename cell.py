...
class Cell:
    ...
    """
    # The dimensions of the cell for the display in the pygame window -> a small blue square of 10x10 pixels
    (length,width) = (10,10) 
    color = (0,0,255)
    ...
    def moving(self):
        ...
        """
        random_direction = random.randint(0,3) # Chosing the direction between 4 possibilities -> north, south, east and west 
